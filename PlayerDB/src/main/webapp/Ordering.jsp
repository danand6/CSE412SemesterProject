			...
			<div id="navbar" class="collapse navbar-collapse">
				<ul class="nav navbar-nav">
					<li class="nav-item"><a class="nav-link"
						href="/PlayerDB/CountryASC.jsp">Order By Country ASC </a></li>
				</ul>
				<ul class="nav navbar-nav">
					<li class="nav-item"><a class="nav-link"
						href="/PlayerDB/CountryDESC.jsp">Order By Country DESC</a></li>
				</ul>
				<ul class="nav navbar-nav">
					<li class="nav-item"><a class="nav-link"
						href="/PlayerDB/AscendingOrder.jsp">Order by Fee ASC</a>
					</li>
				</ul>
				<ul class="nav navbar-nav">
					<li class="nav-item"><a class="nav-link"
						href="/PlayerDB/FeeDESC.jsp">Order by Fee DESC</a></li>
				</ul>
					<ul class="nav navbar-nav">
					<li class="nav-item"><a class="nav-link"
						href="/PlayerDB/ClubASC.jsp">Order by Club ASC </a></li>
				</ul>
				<ul class="nav navbar-nav">
					<li class="nav-item"><a class="nav-link"
						href="/PlayerDB/ClubDESC.jsp">Order by Club DESC</a></li>
				</ul>

            	...
            	connection = DriverManager.getConnection("jdbc:postgresql://localhost:5433/CSE412",
					"root", "root");
		 				preparedStatement = connection
								.prepareStatement("select * from transfer WHERE fromcountry=?");
			...
			<% 
			 ...
			 Connection connection = DriverManager.getConnection("jdbc:postgresql://localhost:5433/CSE412",
				...
				PreparedStatement preparedStatement = connection
						.prepareStatement("SELECT fromcountry AS Country, SUM(fee) AS total FROM transfer WHERE tocountry = ? GROUP BY fromcountry");
				preparedStatement.setString(1, age);
				ResultSet resultset = preparedStatement.executeQuery();
				int counter = 0;
				...
				while(resultset.next()){ 	
					...
					a.setId(counter);
					a.setFromCountry(resultset.getString(1));
					a.setFee(resultset.getInt(2));

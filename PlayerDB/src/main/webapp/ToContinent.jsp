...
<body>
	...
	<h2 align = "center"> Filter Transfer by Country </h2>
            	...
            	connection = DriverManager.getConnection("jdbc:postgresql://localhost:5433/CSE412",
					"root", "root");
		 				preparedStatement = connection
								.prepareStatement("c.	SELECT * FROM transfer INNER JOIN country ON country.countryname = transfer.fromcountry WHERE transfer.continent = ?");
			...
			<% 
			 ...
			 Connection connection = DriverManager.getConnection("jdbc:postgresql://localhost:5433/CSE412",
				...
				PreparedStatement preparedStatement = connection
						.prepareStatement("SELECT * FROM transfer INNER JOIN country ON country.countryname = transfer.fromcountry WHERE country.continent = ?");
				preparedStatement.setString(1, age);
				ResultSet resultset = preparedStatement.executeQuery();
				int counter = 0;

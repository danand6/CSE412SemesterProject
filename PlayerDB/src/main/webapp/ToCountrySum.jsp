...
<body>
	...
	<h2 align = "center"> To Country Total Sum </h2>
			...
			<% 
			 ...
			 Connection connection = DriverManager.getConnection("jdbc:postgresql://localhost:5433/CSE412",
				...
				PreparedStatement preparedStatement = connection
						.prepareStatement("SELECT tocountry AS Country, SUM(fee) AS total FROM transfer WHERE fromcountry = ? GROUP BY tocountry");
				preparedStatement.setString(1, age);
				ResultSet resultset = preparedStatement.executeQuery();
				int counter = 0;

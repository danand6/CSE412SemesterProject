			...
			<div id="navbar" class="collapse navbar-collapse">
				<ul class="nav navbar-nav">
					<li class="nav-item"><a class="nav-link"
						href="/PlayerDB/FilterbyCountry.jsp">Filter By Country </a></li>
				</ul>
				<ul class="nav navbar-nav">
					<li class="nav-item"><a class="nav-link"
						href="/PlayerDB/FilterbyPosition.jsp">Filter by Position</a></li>
				</ul>
				<ul class="nav navbar-nav">
					<li class="nav-item"><a class="nav-link"
						href="/PlayerDB/FilterbyFee.jsp">Filter by Fee</a>
					</li>
				</ul>
				<ul class="nav navbar-nav">
					<li class="nav-item"><a class="nav-link"
						href="/PlayerDB/FilterbyAgeDisplay.jsp">Filter by Age </a></li>
				</ul>
			</div>
